...
class ColorsManager {
  static const Color mainGreen = Color(0xFF247000);
  static const Color lightGreen = Color(0xFF244000);
  static const Color darkGreen = Color(0xFF242424);
  ...
  static const Color textMainColor = Color(0xFF1F2633);
}
